			...
			<div class="panel-heading">
				<div class="row">
					<div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
							<h3 class="panel-title"><i class="glyphicon glyphicon-user"></i> User Lists</h3>
					</div>
					<div align="right" class="col-lg-2 col-md-2 col-sm-4 col-xs-6">
							<button type="button" name="add" id="add_button" data-toggle="modal" data-target="#userModal" class="btn btn-success btn-xs" align="right">Add New User</button>
					</div>
				</div>				
			</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(document).on('click', '.update', function(){
			...
			$.ajax({
				url:'<?php echo base_url(); ?>user/fetch_single',
				method:'POST',
				...
				success:function(data)
				{
					...
					$('.modal-title').html('<i class="glyphicon glyphicon-edit"></i> Edit User');
					$('#user_id').val(user_id);
					$('#action').val('Edit');
					$('#btn_action').val('Edit');
